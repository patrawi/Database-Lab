...
app.post("/edit/:id", (req, res) => {
  const update_student_id = req.body.student_id;
  ...
  const current_student_id = req.params.id;
  connection.query(
    "UPDATE `takes` SET student_id = ?, cid = ?, sect_id = ?, semester = ?, year = ?, grade = ? WHERE student_id = ?",
    [
      update_student_id,
      update_cid,
      update_sect_id,
